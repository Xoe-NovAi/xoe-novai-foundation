...
6. **Arcana-Nova Distinction**: The strategy clearly separates Arcana-Nova (esoteric layer) from Foundation (technical layer). The Arcana references currently in Foundation docs (Maat, Ten Pillars) — should they be:
