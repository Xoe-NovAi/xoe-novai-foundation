...
**Security**: Gemini CLI enforces Maat-aligned validation before executing tool-suggested commands.

## Security & Sovereignty Guardrails

### 🛡️ The "Confused Deputy" Mitigation
AI agents cannot chain tools to gain unauthorized access. Each tool call is an atomic unit requiring validation against the 42 Laws of Maat.
