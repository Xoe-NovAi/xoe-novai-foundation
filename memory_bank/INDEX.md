...
| Agent Protocols | `AGENTS.md` | CLI environment, session management | 15KB |
| Gemini Context | `GEMINI.md` | Gemini CLI strategy & policies | 4KB |
...
### Recent Additions (Mar 2, 2026)
- `handovers/RAPTOR-HANDOFF-DOCKER-REFAC-2026-03-02.md` – Docker image size refactor and Opus guidance.
- `docs/architecture/service-wiring.md` – New service wiring and builder/runtime guidelines.
- `memory_bank/research/DOCKER-REFAC-KNOWLEDGE-GAPS-2026-03-02.md` – Research jobs for Cline Kat.
- `memory_bank/research/UI-KNOWLEDGE-GAPS-2026-03-02.md` – UI debugging research and fixes.
- `memory_bank/research/BUILD-HARDENING-KNOWLEDGE-GAPS-2026-03-02.md` – Build process caching and security research.
