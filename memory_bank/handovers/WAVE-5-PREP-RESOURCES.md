...
| Task | Account | Messages | Reason |
|------|---------|----------|--------|
| Raptor Mini | xoe.nova.ai | 50/50 | Daily driver |
| Haiku 4.5 | arcananovaai | 25/50 | Split test ready |
| MiniMax | OpenCode | Unlimited | No GitHub needed |
