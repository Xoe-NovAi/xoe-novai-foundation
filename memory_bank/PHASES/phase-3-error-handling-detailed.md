...
- **File**: `app/XNAi_rag_app/schemas/errors.py`
  ...
  - Covers all error scenarios: validation, authentication, service unavailable, voice, Vulkan, etc. (AWQ removed).
...
- **AWQ Exceptions** (awq_quantizer.py) - 🚫 **REMOVED** (2026-02-28)
  - Implementation discontinued to maintain "torch-free" mandate.
  - Moved to research status / archive.
...
- **test_awq_exceptions.py** - 🚫 **REMOVED** (2026-02-28)
  - Tests archived with AWQ implementation.
