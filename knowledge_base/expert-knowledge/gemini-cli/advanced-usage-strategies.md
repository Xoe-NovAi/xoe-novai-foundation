...
## 🔱 Core Principles: Sovereignty, Maat Alignment, and Security
...
-   **Maat Alignment:** Interactions and proposed actions are filtered through the 42 Laws of Maat, promoting ethical, just, and non-violent AI development.
...
*   **Xoe-NovAi Elite Context:** The proposed `GEMINI.md` template emphasizes:
    *   **Sovereignty & Ethics:** Maat's 42 Ideals, local-only, torch-free.
...
*   **Application:**
    ...
    *   **Code Audits:** Skills that follow specific checklists for security, performance, or "Maat" compliance.
...
*   **Xoe-NovAi Principles:** `internal_docs/00-system/Maat-Guardrails.md`
