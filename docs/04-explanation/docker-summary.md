# Podman Optimization Initiative - SUMMARY
...
Your Podman images are **2.94GB too large** due to:
...
| Add site-packages cleanup to Podmanfiles | 150MB | 45 min | 🟢 None |
...
Day 3-4: Add site-packages cleanup to Podmanfiles
...
- [ ] Have Podman installed: `podman --version`
...
3. Run `podman build --progress=plain` → Detailed logs
