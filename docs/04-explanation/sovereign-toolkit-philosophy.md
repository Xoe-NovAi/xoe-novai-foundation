...
- **IDE Assistants**: Point tools like Cline or Cursor to the `memory_bank/` to ensure they never suggest a solution that violates your established patterns or Maat ideals.
