...
This document provides a concise, technical overview of the Xoe-NovAi Foundation stack for developers and AI assistants.
...
- Deployment & Podman optimizations: `DOCKER_OPTIMIZATION_SUMMARY.md`
