...
**Podmanfile:** Podmanfile.chainlit  
...
**Podmanfile:** Podmanfile.curation_worker  
...
### Chainlit UI (Podmanfile.chainlit)
...
### Crawler (Podmanfile.crawl) - OPTIMIZATION OPPORTUNITIES
...
### Curation Worker (Podmanfile.curation_worker)
...
3. ⚠️ **Remove dev dependencies from crawler** - Drop pytest, black, mypy from Podmanfile.crawl
...
4. Update Podmanfile.crawl with optimizations
