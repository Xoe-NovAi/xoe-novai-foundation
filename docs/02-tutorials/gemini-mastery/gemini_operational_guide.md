...
- Maat-aligned ethical AI development
...
- **Maat Alignment**: 42 Laws enforced in all interactions
...
- **Prompt Engineering**: Maat-aligned, consciousness-aware prompts
...
# One-shot query
gemini "Explain this Python code following Maat principles"
...
### Advanced Usage
- [Prompt Engineering](projects/gemini-cli-integration/prompt-engineering.md) - Maat-aligned prompt patterns
...
- [Ethical Injection](projects/gemini-cli-integration/ethical-injection.md) - Maat principle enforcement
...
### Ethical Alignment
- **Maat Framework**: 42 Laws enforced in all interactions
...
- `expert-knowledge/security/`: Hardening and Maat alignment strategies.
