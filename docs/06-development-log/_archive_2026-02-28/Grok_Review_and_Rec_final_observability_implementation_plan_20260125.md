...
- **Sovereignty & Maat Alignment**: Local-only console output ensures zero telemetry leaks; philosophical integration of Maat ideals (e.g., ethical logging) is unique to Xoe-NovAi but non-intrusive.
