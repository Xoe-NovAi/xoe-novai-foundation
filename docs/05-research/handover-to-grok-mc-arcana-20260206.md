...
- **`systemPatterns.md`**: Maat-aligned architecture, security trinity, sovereignty patterns
...
- **Core Functions**:
  ...
  - Maat's 42 Ideals as ethical RAG filters
...
*"Truth is the heart of Maat, and balance is its breath."* — Egyptian Proverb
