...
class MultiProviderDispatcher:
    ...
    async def _dispatch_antigravity(
        ...
        try:
            ...
            return DispatchResult(success=False, provider="opencode", account=account, error="opencode timeout")
        except Exception as e:
            return DispatchResult(success=False, provider="opencode", account=account, error=str(e))
    ...
    async def _dispatch_cline(
        ...
        try:
            ...
            return DispatchResult(success=False, provider="cline", account=account, error="Cline timeout")
        except Exception as e:
            return DispatchResult(success=False, provider="cline", account=account, error=str(e))
    ...
    async def _dispatch_copilot(
        ...
        try:
            ...
            return DispatchResult(success=False, provider="copilot", account=account, error="Copilot timeout")
        except Exception as e:
            return DispatchResult(success=False, provider="copilot", account=account, error=str(e))
