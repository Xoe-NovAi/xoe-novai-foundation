...
**Version**: 1.3.0 | **Date**: 2026-02-27 | **Status**: ACTIVE  
...
**Sprint 4 Fixes**: Added memory issues section (2026-02-27) - See `docs/reference/IDE-CLI-KNOWN-ISSUES.md`
...
### Memory Issues (CRITICAL - 2026-02-27)
...
- **Mitigation**:
  ...
  - Backup database before clearing: `cp ~/.local/share/opencode/opencode.db ~/.local/share/opencode/opencode.db.backup`
...
#### Context Compaction
- **Symptom**: "Compacting conversation..." messages频繁
