...
fast →[](javascript:void\(0\))pip install "fastapi[standard]"  
...
fast →[](javascript:void\(0\))fastapi dev main.py  
...
fast →[](javascript:void\(0\))fastapi login  
...
fast →[](javascript:void\(0\))fastapi deploy  
