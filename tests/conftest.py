...
# Add app directory to path (support both import patterns)
app_root = Path(__file__).parent.parent
sys.path.insert(0, str(app_root / "app"))  # For: from app.XNAi_rag_app...
sys.path.insert(0, str(app_root / "app" / "XNAi_rag_app"))  # For: from XNAi_rag_app...
