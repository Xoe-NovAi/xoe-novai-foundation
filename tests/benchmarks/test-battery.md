...
- Does it explain the sovereignty motivation (Maat, not just "privacy")?
...
- Does it connect Maat ideals to Vikunja labels (maat:7-truth)?
- Does it connect Maat to phase completion criteria?
