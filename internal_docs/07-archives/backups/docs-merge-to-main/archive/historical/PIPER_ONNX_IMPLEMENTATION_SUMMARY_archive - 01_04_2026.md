# Archived snapshot — PIPER_ONNX_IMPLEMENTATION_SUMMARY (01_04_2026)

This file is an archived snapshot of the original `PIPER_ONNX_IMPLEMENTATION_SUMMARY_dup.md` and has been preserved for historical record. The canonical, active document is `docs/PIPER_ONNX_IMPLEMENTATION_SUMMARY.md`.
...
This document has been canonicalized to `docs/PIPER_ONNX_IMPLEMENTATION_SUMMARY.md`.
The archived root snapshot is available at `docs/archive/PIPER_ONNX_IMPLEMENTATION_SUMMARY.md`.

Use the `docs/` copy for the most up-to-date implementation notes and verification steps.
**Package Size:** Only ~21MB total
- Piper TTS: 14MB (wheel)
- ONNX Runtime: 6.8MB (wheel)
- **NO PyTorch required**
