...
**Note:** This document was moved into `docs/` on 2026-01-04. See `docs/POLICIES.md` and `docs/DOCS_STRATEGY.md` for canonical workflow.
...
(Full content preserved from original root file; moved into `docs/`.)
...
7. ✅ Added piper model selection configuration (`piper_model` parameter)
