...
This report establishes the transition of the Xoe-NovAi stack into an **Autonomous Self-Optimizing Entity**. In an 8GB Ryzen environment, performance is a dynamic negotiation between thermals, memory pressure, and model precision.

---

## 2. Phase 1 Research Priorities (Improved Template)

### 🔍 Priority 1: The "Sovereign Governor" (Thermal & Power-Aware Scheduling)
...
- **Research Scope**:
    ...
    - Define a **"Degradation Map"**: Trigger Q4_K_S model swap at >85°C.
...
### 🔍 Priority 2: Graph-Relational Hybrid RAG (The "Ma'at" Truth Engine)
...
- **Research Scope**:
    - Research **Kùzu Graph** (embedded) vs. SQLite-FTS5.
...
### 🔍 Priority 3: Speculative KV-Cache & Layer Sharding
...
### 🔍 Priority 4: Zero-Copy Audio & IPC Mastery
