...
Human Director needs to share visual artifacts (code errors, UI state, mermaid diagrams). Visual RAG allows the entity to "see" and reason about the same artifacts as the human.
